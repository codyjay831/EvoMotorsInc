...
const PRIMARY_BEAT = {
  eyebrow: "EVO MOTORS",
  headline: "Buy the right EV without guesswork.",
  subtext: "Hand-picked used EVs, practical charging guidance, and local support for East Bay drivers.",
} as const;
...
export function HeroStorySection({ className }: HeroStorySectionProps) {
  return (
    <section
      ...
      aria-label="Hero"
    >
      <div className="relative min-h-[100svh] w-full overflow-hidden md:min-h-[85svh] md:max-h-[900px]">
        {/* Mobile hero image */}
        ...
        <div className="relative z-10 flex min-h-[inherit] max-h-[inherit] flex-col justify-between px-5 pb-12 pt-24 md:px-[8vw] md:pb-16 md:pt-28">
          <div className="md:max-w-xl md:self-start md:pt-[min(12vh,6rem)]">
            ...
            <p className="mt-5 max-w-[32ch] text-base leading-relaxed text-white/80 md:max-w-lg md:text-lg">
              {PRIMARY_BEAT.subtext}
            </p>
          </div>

          <div className="mt-10 w-full md:mt-0 md:w-auto">
            <div className="space-y-2 rounded-xl bg-black/30 px-4 py-4 backdrop-blur md:inline-flex md:flex-row md:flex-wrap md:items-center md:gap-3 md:bg-transparent md:p-0 md:backdrop-blur-none">
              <Link
                href="/inventory"
              ...
              <Link
                ...
                className="inline-flex h-12 w-full items-center justify-center rounded-lg border border-white/25 bg-white/10 px-5 py-3 text-sm font-medium text-white transition-colors duration-200 hover:bg-white/20 evo-focus-ring md:h-10 md:w-auto md:px-6"
              >
                Request a Vehicle
              </Link>
              ...
              <Link
                href="/ev-charging"
                className="inline-flex h-10 items-center justify-center rounded-lg px-3 text-sm font-medium text-white/90 transition-colors duration-200 hover:text-white evo-focus-ring md:h-10"
              >
                EV Charging Guide
              </Link>
            </div>
