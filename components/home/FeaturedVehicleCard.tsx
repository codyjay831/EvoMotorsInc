  ...
  const card = (
    <Link
      ...
      className={cn(
        ...
        "hover:translate-y-[-6px] hover:shadow-[0_20px_40px_-12px_rgba(0,0,0,0.5),0_1px_0_0_rgb(255_255_255_/_0.05)] motion-reduce:hover:translate-y-0",
        "evo-focus-ring"
      )}
    >
      <div className="relative h-[200px] sm:h-[220px] overflow-hidden bg-muted/30">
        {imageUrl ? (
          <Image
            ...
            className="object-cover transition-transform duration-[350ms] ease-out group-hover:scale-[1.03] motion-reduce:transition-none motion-reduce:group-hover:scale-100"
          />
        ) : (
